...
LABEL "com.gusrub.product"="BMI Calculator"
LABEL "version"="1.0"
LABEL "description"="This is a simple application that allows users to sign up and calculate their body mass index or short for BMI, given their weight and heigh, based on WHO standards."
